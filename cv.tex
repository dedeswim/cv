...
% Author name bolding is handled in the custom name format in awesome-cv.cls
...
\position{PhD Student in Computer Science @ ETH Z{\"u}rich}
% \address{42-8, Bangbae-ro 15-gil, Seocho-gu, Seoul, 00681, Rep. of KOREA}

\mobile{(+41) 76 699 43 27}
\email{edebenedetti@inf.ethz.ch}
% \email{edoardo.m.debenedetti@gmail.com}
\homepage{https://edoardo.science}
\github{dedeswim}
...
%-------------------------------------------------------------------------------
\descriptionlabel{\footnotesize \centering Last update \today.}
\end{document}
